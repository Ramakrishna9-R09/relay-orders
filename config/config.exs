...
config :relay,
  ...
  api_key_pepper: System.get_env("API_KEY_PEPPER", "development-only-pepper"),
  requests_per_minute: String.to_integer(System.get_env("REQUESTS_PER_MINUTE", "120"))
...
config :relay, RelayWeb.Endpoint,
  ...
  live_view: [signing_salt: "8zA8pcQY"]
